...
#[test]
fn owner_v2_sanity() -> Result<(), mimble_wallet_controller::Error> {
	...
	let arg_vec = vec!["mimble-wallet", "-p", "password", "owner_api"];
	// Set running
	thread::spawn(move || {
	...
	assert_eq!(value.1.amount_currently_spendable, 36666666666); // grin: 420000000000
